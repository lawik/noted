defmodule Noted.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule NotedWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: Noted.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: NotedWeb.Router},
      Plugins.Ecto,
      # Plugins.Oban,
      Plugins.PhoenixLiveView

      # Add your own PromEx metrics plugins
      # Noted.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:noted, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
